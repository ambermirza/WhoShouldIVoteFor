...
var questions = [
        {
        "Should the government continue funding of Planned Parenthood?": [
            "No"
        ]
    },
    {
...
var CARD_TITLE = "Nominees"; 

function getWelcomeResponse(callback) {
    // Be sure to change this for your skill.
    var sessionAttributes = {},
        //CHANGE THIS TEXT
        speechOutput = "I will tell you " + GAME_LENGTH.toString()
            + " positions on inssues, tell me if you agree with them. Just answer with Yes or No. Let's begin. ",
...
function handleAnswerRequest(intent, session, callback) {
    ...
    if (!gameInProgress) {
        ...
        if (currentQuestionIndex == GAME_LENGTH - 1) {
            ...
            if (currentScore > 2) {
                            speechOutput += speechOutputAnalysis + "Based on your answers you should vote for Hillary Clinton. Thank you for learning with Alexa!";
            callback(session.attributes,
                buildSpeechletResponse(CARD_TITLE, speechOutput, "", true));
            } else {
                            speechOutput += speechOutputAnalysis + "Ok, based on your answers you should vote for Donald Trump. Thank you for learning with Alexa!";
            callback(session.attributes,
                buildSpeechletResponse(CARD_TITLE, speechOutput, "", true));
            }
           ...
           speechOutput += userGaveUp ? "" : " ";
            speechOutput += speechOutputAnalysis + "Let's move onto the next issue. " + repromptText;
...
function handleFinishSessionRequest(intent, session, callback) {
    ...
    callback(session.attributes,
        buildSpeechletResponseWithoutCard("Thanks for playing Nominees!", "", true));
}
